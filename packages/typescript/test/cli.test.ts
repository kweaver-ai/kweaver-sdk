...
//
// This is exhaustive: every command path that has a `--help` must appear here.
// Adding a new command requires adding its --help path. Drop-back to
// hardcoded `console.log("kweaver ...")` will fail the USAGE assertion.
test("renderHelp section titles present across ALL --help paths", async () => {
  const cases: Array<{ args: string[]; needs: string[] }> = [
    // ── Top-level ────────────────────────────────────────────────────────
    { args: ["--help"], needs: ["USAGE", "FLAGS", "EXAMPLES"] },

    // ── Authentication & config ──────────────────────────────────────────
    { args: ["auth", "--help"], needs: ["USAGE", "AVAILABLE COMMANDS"] },
    { args: ["auth", "login", "--help"], needs: ["USAGE", "FLAGS", "EXAMPLES"] },
    { args: ["auth", "users", "--help"], needs: ["USAGE"] },
    { args: ["auth", "switch", "--help"], needs: ["USAGE"] },
    { args: ["auth", "whoami", "--help"], needs: ["USAGE"] },
    { args: ["auth", "export", "--help"], needs: ["USAGE"] },
    { args: ["auth", "change-password", "--help"], needs: ["USAGE"] },
    ...
    { args: ["agent", "get", "--help"], needs: ["USAGE"] },
    { args: ["agent", "list", "--help"], needs: ["USAGE"] },
    { args: ["agent", "personal-list", "--help"], needs: ["USAGE"] },
    { args: ["agent", "category-list", "--help"], needs: ["USAGE"] },
    { args: ["agent", "template-list", "--help"], needs: ["USAGE"] },
    { args: ["agent", "template-get", "--help"], needs: ["USAGE"] },
    { args: ["agent", "sessions", "--help"], needs: ["USAGE"] },
    { args: ["agent", "history", "--help"], needs: ["USAGE"] },
    { args: ["agent", "trace", "--help"], needs: ["USAGE"] },
    { args: ["agent", "update", "--help"], needs: ["USAGE"] },
    { args: ["agent", "create", "--help"], needs: ["USAGE"] },
    // NOTE: `agent publish --help` is a pre-existing bug — the handler exits 1
    // when args[0] starts with `-` (checked before `--help` recognition). The
    // help text exists and uses renderHelp, but the dispatcher never reaches
    // it. Not covered here; should be fixed in a separate behavior PR.
    { args: ["agent", "skill", "--help"], needs: ["USAGE", "AVAILABLE COMMANDS"] },
    { args: ["toolbox", "--help"], needs: ["USAGE", "AVAILABLE COMMANDS"] },
    { args: ["tool", "--help"], needs: ["USAGE", "AVAILABLE COMMANDS"] },

    // ── AI Data Platform: bkn ────────────────────────────────────────────
    ...
    { args: ["bkn", "search", "--help"], needs: ["USAGE"] },
    ...
    { args: ["bkn", "subgraph", "--help"], needs: ["USAGE"] },
    { args: ["bkn", "action-execution", "get", "--help"], needs: ["USAGE"] },
    { args: ["bkn", "action-log", "--help"], needs: ["USAGE"] },
    { args: ["bkn", "action-schedule", "--help"], needs: ["USAGE"] },
    { args: ["bkn", "job", "--help"], needs: ["USAGE"] },
    { args: ["bkn", "object-type", "--help"], needs: ["USAGE"] },
    { args: ["bkn", "relation-type", "--help"], needs: ["USAGE"] },
    { args: ["bkn", "action-type", "--help"], needs: ["USAGE"] },
    { args: ["bkn", "concept-group", "--help"], needs: ["USAGE", "AVAILABLE COMMANDS"] },
    ...
    { args: ["vega", "inspect", "--help"], needs: ["USAGE"] },
    { args: ["vega", "catalog", "--help"], needs: ["USAGE", "AVAILABLE COMMANDS"] },
    { args: ["vega", "catalog", "list", "--help"], needs: ["USAGE", "FLAGS"] },
    { args: ["vega", "catalog", "get", "--help"], needs: ["USAGE"] },
    { args: ["vega", "catalog", "health", "--help"], needs: ["USAGE"] },
    { args: ["vega", "catalog", "test-connection", "--help"], needs: ["USAGE"] },
    { args: ["vega", "catalog", "discover", "--help"], needs: ["USAGE"] },
    { args: ["vega", "catalog", "resources", "--help"], needs: ["USAGE"] },
    { args: ["vega", "catalog", "create", "--help"], needs: ["USAGE", "FLAGS"] },
    { args: ["vega", "catalog", "update", "--help"], needs: ["USAGE", "FLAGS"] },
    { args: ["vega", "catalog", "delete", "--help"], needs: ["USAGE"] },
    { args: ["vega", "resource", "--help"], needs: ["USAGE", "AVAILABLE COMMANDS"] },
    { args: ["vega", "resource", "list", "--help"], needs: ["USAGE", "FLAGS"] },
    { args: ["vega", "resource", "list-all", "--help"], needs: ["USAGE"] },
    { args: ["vega", "resource", "get", "--help"], needs: ["USAGE"] },
    { args: ["vega", "resource", "query", "--help"], needs: ["USAGE"] },
    { args: ["vega", "resource", "create", "--help"], needs: ["USAGE", "FLAGS"] },
    { args: ["vega", "resource", "update", "--help"], needs: ["USAGE"] },
    { args: ["vega", "resource", "delete", "--help"], needs: ["USAGE"] },
    { args: ["vega", "dataset", "--help"], needs: ["USAGE", "AVAILABLE COMMANDS"] },
    { args: ["vega", "dataset", "create-docs", "--help"], needs: ["USAGE"] },
    { args: ["vega", "dataset", "update-docs", "--help"], needs: ["USAGE"] },
    { args: ["vega", "dataset", "delete-docs", "--help"], needs: ["USAGE"] },
    { args: ["vega", "dataset", "delete-docs-query", "--help"], needs: ["USAGE"] },
    { args: ["vega", "dataset", "build", "--help"], needs: ["USAGE"] },
    { args: ["vega", "dataset", "build-status", "--help"], needs: ["USAGE"] },
    { args: ["vega", "query", "--help"], needs: ["USAGE", "AVAILABLE COMMANDS"] },
    { args: ["vega", "query", "execute", "--help"], needs: ["USAGE"] },
    { args: ["vega", "sql", "--help"], needs: ["USAGE"] },
    { args: ["vega", "connector-type", "--help"], needs: ["USAGE", "AVAILABLE COMMANDS"] },
    { args: ["vega", "connector-type", "list", "--help"], needs: ["USAGE"] },
    { args: ["vega", "connector-type", "get", "--help"], needs: ["USAGE"] },
    { args: ["vega", "connector-type", "register", "--help"], needs: ["USAGE"] },
    { args: ["vega", "connector-type", "update", "--help"], needs: ["USAGE"] },
    { args: ["vega", "connector-type", "delete", "--help"], needs: ["USAGE"] },
    { args: ["vega", "connector-type", "enable", "--help"], needs: ["USAGE"] },
    { args: ["context-loader", "--help"], needs: ["USAGE", "RECOMMENDED FLOW"] },
    { args: ["context-loader", "config", "--help"], needs: ["USAGE"] },
    ...
    { args: ["skill", "list", "--help"], needs: ["USAGE"] },
    { args: ["skill", "market", "--help"], needs: ["USAGE"] },
    { args: ["skill", "get", "--help"], needs: ["USAGE"] },
    { args: ["skill", "market-get", "--help"], needs: ["USAGE"] },
    { args: ["skill", "register", "--help"], needs: ["USAGE"] },
    { args: ["skill", "set-status", "--help"], needs: ["USAGE"] },
    { args: ["skill", "delete", "--help"], needs: ["USAGE"] },
    { args: ["skill", "update-metadata", "--help"], needs: ["USAGE"] },
    { args: ["skill", "update-package", "--help"], needs: ["USAGE"] },
    { args: ["skill", "history", "--help"], needs: ["USAGE"] },
    { args: ["skill", "republish", "--help"], needs: ["USAGE"] },
    { args: ["skill", "publish-history", "--help"], needs: ["USAGE"] },
    { args: ["skill", "content", "--help"], needs: ["USAGE"] },
    { args: ["skill", "read-file", "--help"], needs: ["USAGE"] },
    { args: ["skill", "download", "--help"], needs: ["USAGE"] },
    { args: ["skill", "install", "--help"], needs: ["USAGE"] },
    { args: ["skill", "management-content", "--help"], needs: ["USAGE"] },
    { args: ["skill", "management-read-file", "--help"], needs: ["USAGE"] },
    { args: ["skill", "management-download", "--help"], needs: ["USAGE"] },
  ];
